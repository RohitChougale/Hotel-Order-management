export default function Home() {
  ...
  🍽️ Welcome to <span className="text-blue-600">Restaurant Dashboard</span>
</h1>
 
        <p className="text-lg text-gray-600 mb-8 animate-fade-in delay-100">
          A smart way to manage your orders, kitchen, and menu – all in one place!
        </p>
        ...
        <div className="mt-10 text-sm text-gray-500">
          Made by <span className="font-medium text-gray-700">Pulses Technology</span>
        </div>
      </div>
    </div>
  );
